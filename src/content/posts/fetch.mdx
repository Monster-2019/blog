...
category: "前端开发"
description: 从请求封装思路出发，基于原生 Fetch 构建更轻量的前端请求工具，减少依赖体积并统一请求处理逻辑。
---
...
const refreshToken = params =>
  fetchApi.get(`${base_url}/auth/refresh_token`, params);
```
...
```javascript
fetchApi("/api/login", { username: "monster", password: 123456 }).then(
  res => xxx
);
```
